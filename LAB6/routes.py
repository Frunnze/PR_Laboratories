...
@swag_from("electro_scooters_list.yml")
...
@swag_from("electro_scooter_get.yml")
...
@swag_from("electro_scooter_post.yml")
...
@swag_from("electro_scooter_put.yml")
...
@swag_from("electro_scooter_delete.yml")
